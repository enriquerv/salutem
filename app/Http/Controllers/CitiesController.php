...
use App\Http\Requests\CitiesRequest as MasterRequest;
use App\City as MasterModel;
use App\ViewCity as MasterViewModel;
use App\State;
use Sentinel;
use Redirect;
...
class CitiesController extends Controller
{
    public function __construct() {
        $this->middleware('permissionsCity');
        ...
        //Catalogs
        $this->catalog_state_id = State::all()->pluck('name', 'id');
    }
    ...
    public function create()
    {
        ...
        return view('admin.create', compact($this->compact, 'catalog_state_id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit', compact($this->compact, 'item', 'catalog_state_id'));
    }
