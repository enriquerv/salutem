...
use App\Http\Requests\CountriesRequest as MasterRequest;
use App\Country as MasterModel;
use App\ViewCountry as MasterViewModel;
use Sentinel;
use Redirect;
...
class CountriesController extends Controller
{
    public function __construct() {
        $this->middleware('permissionsCountry');
